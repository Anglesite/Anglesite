    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                step(2) {
                    Text("Select **All repositories**, then grant **Contents: Read and write**, **Administration: Read and write** (Administration lets Anglesite create a new project on GitHub), **Repository security advisories: Read**, and **Dependabot alerts: Read** (both let Anglesite show this site's open security reports) — then copy the token and paste it below.")
                }
            }
            .font(.callout)
            .fixedSize(horizontal: false, vertical: true)
