...
final class PublishModel {
    ...
    /// Awaits this model's current publish, if one is running — used by `SiteWindowModel.close()`
    /// to defer unregistering this site's source-publish-gate provider until an in-flight publish
