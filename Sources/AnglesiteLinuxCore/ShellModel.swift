...
public actor ShellModel {
    ...
    /// - Returns: The engine source, or `nil` when no candidate file is readable.
    public static func engineSource(environment: [String: String] = ProcessInfo.processInfo.environment) -> String? {
    ...
    public static func engineCandidates(environment: [String: String]) -> [String] {
        [
