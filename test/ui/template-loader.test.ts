...
describe('template-loader', () => {
  ...
  describe('loadTemplate', () => {
    ...
    it('should throw error when template file does not exist', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Failed to load template missing-template:', expect.any(Error));
    ...
    it('should throw error when file read fails', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Failed to load template read-error-template:', readError);
