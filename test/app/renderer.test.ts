/**
 * @file Tests for Electron renderer process
...
describe('Renderer Tests', () => {
  ...
  describe('logElectronAPIAvailability', () => {
    it('should log availability without errors', () => {
      expect(() => logElectronAPIAvailability()).not.toThrow();
    });
  });

  describe('logDocumentReadyState', () => {
    it('should log state without errors', () => {
      expect(() => logDocumentReadyState()).not.toThrow();
    });
  });

  describe('sendRendererLoadedMessage', () => {
    it('should send message when electronAPI is available', () => {
      sendRendererLoadedMessage();
  ...
  describe('setupDOMContentLoadedHandler', () => {
    it('should set up DOMContentLoaded handler', () => {
      ...
      // The handler runs but doesn't log anything anymore
