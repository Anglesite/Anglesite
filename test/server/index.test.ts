...
describe('Server Module Exports', () => {
  it('should export eleventy functions', () => {
    ...
    expect(typeof serverModule.switchToWebsite).toBe('function');
    expect(typeof serverModule.startDefaultEleventyServer).toBe('function');
    expect(typeof serverModule.cleanupEleventyServer).toBe('function');
    expect(typeof serverModule.generateTestDomain).toBe('function');
